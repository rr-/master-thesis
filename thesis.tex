...
losowego wybrania tego elementu ze zbioru $B$, lub też -- wszystkie wartości ze
zbioru $B$ powinny mieć możliwie taką samą szansę na wybranie.
%todo: ściślej
...
$$
    ...
    \end{aligned}
$$
%todo: wzorki wprowadzają prawdopodobieństwo w zły sposób (sugerują, że hasze
...
%todo: coś o zasadzie Kerchoffsa
...
\begin{itemize}
%todo: coś tu jest nie tak, nawet nieformalnie
%podkreślone: "każdy"
