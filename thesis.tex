...
jednostajnym rozkładem prawdpodobieństwa.
\end{itemize}
...
%todo: rycina takiego odwzorowania
...
%todo: rycina z dobrym i złym przykładem
...
\myparagraph{Podstawowa odporność na kolizje (\textit{collision resistance})}
...
\myparagraph{Nieodróżnialność od \textit{random oracles}}
...
Dlaczego pojawiało się tyle propozycji, kiedy można wymyślić jedną uniwersalną
funkcję, odporną na każdy rodzaj ataku? Problem leży w tym, że jak do tej pory
nie udowodniono istnienia takiej funkcji w praktyce. W związku z tym od lat
