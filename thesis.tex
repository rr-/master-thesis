...
\usepackage{xparse} %skomplikowane komendy
...
\NewDocumentCommand{\en}{sm}{\foreignlanguage{english}{\IfBooleanF{#1}{\textit{#2}}\IfBooleanT{#1}{#2}}}
...
ogłoszonego przez \en*{National Institute of Standards and Technology}, mającego
...
o~konstrukcję Merkle-Damg\r{a}rda. Została skonstruowana przez \en*{National
...
\texttt{SHA-1} zwraca skróty o~długości 160~bitów. Konstrukcja funkcji została
...
\begin{myenumerate}
    ...
    \begin{myenumerate}
        ...
        \begin{itemize}
            ...
            \item Skonstruuj dodatkowe wektory $W_{16 \leq j \leq 79}$ zgodnie
            z~wzorem:
