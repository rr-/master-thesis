...
void fix_sc(uint32_t *state1, uint32_t *state2, size_t i, sufficient_cond *sc)
{
	...
	state2[i] = state1[i] - differences[i - 1];
}
	...
	uint32_t *state2)
{
	...
	sufficient_cond sc[64] =
	{
		...
		/*  d6 */ { 0, 0, 0 },
		/*  c6 */ { 0, 0, 0 },
		/*  b6 */ { 0x00000000, 0x00000000, 0x00000000 },
		/*  a7 */ { 0x00000000, 0x00000000, 0x00000000 },
		/*  d7 */ { 0x00000000, 0x00000000, 0x00000000 },
		/*  c7 */ { 0x00000000, 0x00000000, 0x00000000 },
		/*  b7 */ { 0x00000000, 0x00000000, 0x00000000 },
		/*  a8 */ { 0x00000000, 0x00000000, 0x00000000 },
		/*  d8 */ { 0x00000000, 0x00000000, 0x00000000 },
		/*  c8 */ { 0x00000000, 0x00000000, 0x00000000 },
		/*  b8 */ { 0x00000000, 0x00000000, 0x00000000 },
		/*  a9 */ { 0x00000000, 0x00000000, 0x00000000 },
		/*  d9 */ { 0x00000000, 0x00000000, 0x00000000 },
		/*  c9 */ { 0x00000000, 0x00000000, 0x00000000 },
		/*  b9 */ { 0x00000000, 0x00000000, 0x00000000 },
		/* a10 */ { 0x00000000, 0x00000000, 0x00000000 },
		/* d10 */ { 0x00000000, 0x00000000, 0x00000000 },
		/* c10 */ { 0x00000000, 0x00000000, 0x00000000 },
		/* b10 */ { 0x00000000, 0x00000000, 0x00000000 },
		/* a11 */ { 0x00000000, 0x00000000, 0x00000000 },
		/* d11 */ { 0x00000000, 0x00000000, 0x00000000 },
		/* c11 */ { 0x00000000, 0x00000000, 0x00000000 },
		/* b11 */ { 0x00000000, 0x00000000, 0x00000000 },
		/* a12 */ { 0x00000000, 0x00000000, 0x00000000 },
		/* d12 */ { 0x00000000, 0x00000000, 0x00000000 },
		/* c12 */ { 0x00000000, 0x00000000, 0x00000000 },
		/* b12 */ { 0, 0, 0 },
		/* a13 */ { 0, 0, 0 },
		/* d13 */ { 0, 0, 0 },
		/* c13 */ { 0, 0, 0 },
	...
	uint32_t *state2)
{
	...
	sufficient_cond sc[64] =
	{
		/*  a1 */ { 0x0a000820, 0x84200000, 0x00000000 },
		/*  d1 */ { 0x02208026, 0x8c000800, 0x701f10c0 },
		/*  c1 */ { 0x40201080, 0xbe1f0966, 0x00000018 },
		/*  b1 */ { 0x443b19ee, 0xba040010, 0x00000601 },
		/*  a2 */ { 0xb41011af, 0x482f0e50, 0x00000000 },
		/*  d2 */ { 0x9a1113a9, 0x04220c56, 0x00000000 },
		/*  c2 */ { 0x083201c0, 0x96011e01, 0x01808000 },
		/*  b2 */ { 0x1b810001, 0x843283c0, 0x00000002 },
		/*  a3 */ { 0x03828202, 0x9c0101c1, 0x00001000 },
		/*  d3 */ { 0x00041003, 0x878383c0, 0x00000000 },
		/*  c3 */ { 0x00021000, 0x800583c3, 0x00086000 },
		/*  b3 */ { 0x0007e000, 0x80081080, 0x7f000000 },
		/*  a4 */ { 0x80000080, 0x3f0fe008, 0x00000000 },
		/*  d4 */ { 0xbf040000, 0x400be088, 0x00000000 },
		/*  c4 */ { 0x82008008, 0x7d000000, 0x00000000 },
		/*  b4 */ { 0, 0, 0 },
		/*  a5 */ { 0, 0, 0 },
		/*  d5 */ { 0, 0, 0 },
		/*  c5 */ { 0x80020000, 0, 0 },
